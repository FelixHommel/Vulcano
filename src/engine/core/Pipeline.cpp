...
void Pipeline::createDescriptorSetLayout()
{
    ...
    const VkDescriptorSetLayoutBinding descLayoutBinding{ .descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                                          .descriptorCount = m_maxDescriptorCount,
                                                          .stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT };
    const VkDescriptorSetLayoutCreateInfo descLayoutCI{ .sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO,
...
void Pipeline::createPipelineLayout(const Shader& shader, const SwapchainImageFormats& imageFormats)
{
    ...
    const VkVertexInputBindingDescription vertexBinding{ .binding = 0,
    ...
    const VkPipelineRenderingCreateInfo renderingCI{ .sType = VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO,
